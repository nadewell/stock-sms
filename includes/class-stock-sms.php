...
class Stock_Sms {
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      Stock_Sms_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct() {
		if ( defined( 'STOCK_SMS_VERSION' ) ) {
			$this->version = STOCK_SMS_VERSION;
		} else {
			$this->version = '1.0.0';
		}
		$this->plugin_name = 'stock-sms';
	 ...
	 *
	 * - Stock_Sms_Loader. Orchestrates the hooks of the plugin.
	 * - Stock_Sms_i18n. Defines internationalization functionality.
	 * - Stock_Sms_Admin. Defines all hooks for the admin area.
	 * - Stock_Sms_Public. Defines all hooks for the public side of the site.
	 *
	...
	private function load_dependencies() {
		 ...
		 * core plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-stock-sms-loader.php';

		/**
		 * The class responsible for defining internationalization functionality
		 * of the plugin.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'includes/class-stock-sms-i18n.php';

		/**
		 * The class responsible for defining all actions that occur in the admin area.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'admin/class-stock-sms-admin.php';

		/**
		 * The class responsible for defining all actions that occur in the public-facing
		 * side of the site.
		 */
		require_once plugin_dir_path( dirname( __FILE__ ) ) . 'public/class-stock-sms-public.php';

		$this->loader = new Stock_Sms_Loader();
	...
	private function set_locale() {
		...
		$plugin_i18n = new Stock_Sms_i18n();
	...
	private function define_admin_hooks() {
		...
		$plugin_admin = new Stock_Sms_Admin( $this->get_plugin_name(), $this->get_version() );
	...
	private function define_public_hooks() {
		...
		$plugin_public = new Stock_Sms_Public( $this->get_plugin_name(), $this->get_version() );
